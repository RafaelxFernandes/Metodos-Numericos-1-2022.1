...
class PATH:
    def __init__(self, L, mode, x, y, yaw):
        ...
        # Ângulos finais da guinada/ curva
        self.yaw = yaw 


# Funções
# - Manipulação de ângulos para correção
def pi_2_pi(theta):
    while theta > math.pi:
        theta -= 2.0 * math.pi
...
def generate_local_course(L, lengths, mode, maxc, step_size):
    ...
    for m, l, i in zip(mode, lengths, range(len(mode))):
        ...
        # Cálculo do comprimento remanescente do percurso
        ll = l - pd - d
